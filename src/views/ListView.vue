  ...
  <v-container>
    <v-row>
      <v-col cols="12">
        ...
        <!-- v-model="newItem" 功能? -->
        <!-- label說明 -->
        <!-- 內建驗證功能，給他function，在使用者輸入後執行，只是顯示給使用者，後台還要另外驗證 :rules="[rules.required,rules.length]" -->
        <!-- ref="newItemInput" 給元件一個id 讓元件做事-->
        <v-col cols="12">
          <v-text-field 
          variant="solo-filled" 
          label="新增事項"
